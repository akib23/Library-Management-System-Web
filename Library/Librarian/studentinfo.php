...
<div id="mySidenav" class="sidenav">
  ...
  <a style="text-decoration:none; " href="updatebook.php">Update Books</a>
...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<div >
		...
		<form action="" method="post">
			<div>
				...
				<input style="width: 300px;float: right; margin: auto; margin-top: 20px; margin-right:10px;" class="form-control" type="text" name="search" placeholder="Search Student">
				<br><br>
				<br>
	...
	<div>
		...
		<br>
		<br>
		<h1 style="color:white; margin-left:30px; ">List Of Students</h1>
		<br>
	...
	die("connection failed".mysqli_connect_error());
		...
		if(isset($_POST['submit']))
		{
			...
			$q=mysqli_query($db,"SELECT * FROM `student` where first like '%$_POST[search]%' or last like '%$_POST[search]%' ");
			...
			echo "<td>";  echo $row['first']; echo " "; echo $row['last'];  echo "</td>";
