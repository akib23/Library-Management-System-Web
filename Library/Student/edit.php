...
<div class="main4">
	<br><br><br>
<h1><center>Update User Information</center></h1>
<br>
<br>
<form name="Registration" action="" method="post">
	<div class="login">
		...
		<input class="form-control" type="number" name="roll" id="roll_no"  placeholder="ID No" required="" readonly value="<?php echo $id; ?>"><br>
...
<?php 
		...
		if(isset($_POST['update']))
		{
			...
			$sql1= "UPDATE student SET first='$first', last='$last', username='$username', password='$password',roll='$id', email='$email', phone='$contact' WHERE username='".$_SESSION['login_user']."';";
