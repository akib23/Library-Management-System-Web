...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<div >
		...
		<form action="" method="post">
			<div>
				...
				<br>
				<br>
				<button style="background-color: white;color: black;float: right; margin: auto; margin-right:70px" type="submit" name="issue" class="btn btn-default">Issue Book
				</button>
	...
	if(isset($_POST['issue'])){
		...
		$res2=mysqli_query($db,"SELECT * from issue_book where bid='$_POST[bid]' and username='$_SESSION[login_user]'; ");
...
<script type="text/javascript">
	alert("The book is not Availabel");
	window.location="books.php";
		...
		$sql = "SELECT * FROM books WHERE bid='$_POST[bid]'";
		...
		mysqli_query($db,"INSERT INTO issue_book values('$_SESSION[login_user]','$_POST[bid]','$name','$author','$edition','NO','NO');");
		?>
		<script type="text/javascript">
